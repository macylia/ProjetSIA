...
<body background="images/petiteFeuille.jpg" color="#ffffff">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method ="POST" action ="ServletFacture" id="popup-form-facture" class='form-horizontal' role="form" data-parsley-validate >
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <label for="invoiceNumber" class="sr-only">Numéro de facture</label>
                            <input class="form-control " type="number" name="invoiceNumber" id="invoiceNumber"
